...
On the other hand, in C/C++ projects, the Macro Operator Precedence AoCs appear often. Gopstein et al. [[1]](#1) described in their paper that the following macro was frequently used in Linux:
```
